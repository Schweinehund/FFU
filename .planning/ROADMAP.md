...
- [x] 52-02-PLAN.md - DGRID-02 select-all visible scope + Save-DriversJson master-list source + driver-grid opt-in + header alignment (f09c989, 42ed281) (DGRID-02)

**Wave 3** *(blocked on Wave 2)*

- [x] 52-03-PLAN.md - DGRID-03 CopyDrivers/BuildUSBDrive dependency throw in BuildFFUVM.ps1 END block, USBOnlyMode-guarded (dc801e9) (DGRID-03)
