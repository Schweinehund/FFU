...
**Requirements**: TBD (run /gsd:define-requirements)
...
- Driver injection phase (non-critical)
- Update injection phase (non-critical)
- WinPE media creation phase (non-critical)
- FFU capture phase (critical)
...
|-------|----------------|--------|-----------|
| 26. Invoke-BuildPhase Integration | 0/? | Not started | - |
